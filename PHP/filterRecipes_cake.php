...
$(document).ready(function(){
    ...
    function filter_data()
    {
        ...
        $.ajax({
            ...
            method:"POST",
            data:{action:action, recipes_time:recipes_time, recipes_difficulty:recipes_difficulty, parve_or_dairy:parve_or_dairy, oven_free:oven_free, mixer_free:mixer_free,
            gluten_free:gluten_free, healthy:healthy},
