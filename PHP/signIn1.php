...
<!-- Button trigger sign in modal - php -->
<?php
    ...
    if (isset($_SESSION['userId'])) {
        ...
        <button type="submit" class="btn btn-secondary" style="color: #212529;background-color: #ffcccc;border-color:lavender;padding: 15px 30px;"> התנתק</button>
        </form>';
    }
    else {
        echo ' <button type="button" class="btn btn-secondary" style="color: #212529;background-color: #ffcccc;border-color:lavender;padding: 15px 30px;"
        data-toggle="modal" data-target="#signinModal">התחבר</button> ';
    }
...
<div class="modal fade" id="signinModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true" dir="rtl">
  <div class="modal-dialog" role="document" >
    <div class="modal-content" >
      ...
      <h5 class="modal-title" id="exampleModalLongTitle" >התחבר </h5> 
    ...
    <label for="userEmailName"><b>שם משתמש/מייל</b></label>
    <input type="text" placeholder="Enter Email/Name" name="userEmailName" id="userEmailName" required>
  ...
  <div class="container signin" dir="rtl">
    <p> אין לך חשבון? <a href=../Includes/signUp.html>הרשם </a></p>
    </div>
    
    <div class="modal-footer">
        <button type="submit" class="btn btn-primary" name="signin-submit" style="color: #212529;background-color: #ffcccc;border-color:lavender;padding: ">התחבר</button>
